...
const Home = () => {
    ...
    return (
        <div className='bg-[#2B2B2B] '>
            ...
            <div className='py-20 px-[115px] font-[work-sans] text-white max-desktop:px-20 max-laptop:px-10'>
                ...
                <div className='flex justify-between items-end mt-[-30px] max-other:flex-wrap max-other:mt-5'>
                    ...
                    <h2 className='text-[22px] font-normal max-ipad:max-w-[500px] max-other:max-w-[600px]'>Checkout Top Rated Creators on the NFT Marketplace</h2>
                ...
                <div className='flex justify-between flex-wrap mt-[45px]'>
                    {
                        creator.map(value => {
                            return (
                                <div className='text-white font-[work-sans] w-[23%] my-[15px] h-auto bg-[#3B3B3B] rounded-[20px] p-5 relative flex justify-center flex-wrap items-center hover:scale-95 ease-linear duration-200 max-desktop:p-4 max-laptop:w-[30%]'>
                                    ...
                                    <h2 className='text-[16px] font-normal text-white font-[space-mono] mt-2 max-desktop:text-[14px]'> <span className='text-[#858584]'>Total Sales:</span> {value.price} ETH</h2>
                                </div>
                            )
                        })
                    }
            ...
            <div className='py-20 px-[115px] font-[work-sans] text-white flex justify-between flex-wrap max-desktop:px-20 max-laptop:px-10'>
