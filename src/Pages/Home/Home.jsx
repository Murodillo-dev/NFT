  ...
  return (
    <div className="bg-[#2B2B2B] ">
        ...
        <div className=" w-[50%] font-[work-sans] max-ipad:w-[100%] max-large:text-center">
          ...
          <div className="max-w-[510px] w-full flex justify-between mt-[30px] bg-transparent max-large:hidden">
            <div className="stat place-items-left p-0">
              <div className="stat-value text-[28px] text-white font-semibold max-ipad:text-[22px] ">
                240K +{" "}
              </div>
              <div className="stat-desc text-[24px] font-[work-sans] text-white leading-10 max-ipad:text-[18px]">
                Total Sale
              </div>
            </div>
        ...
        <div className="w-full hidden mt-[30px] bg-transparent max-large:block">
          <div className="flex justify-center">
            <div className="stat place-items-left p-0 text-center">
              <div className="stat-value text-[28px] text-white font-semibold max-ipad:text-[22px] max-large:text-[28px] max-meduim:text-[22px]">
                240K +{" "}
              </div>
              <div className="stat-desc text-[24px] font-[work-sans] text-white leading-10 max-ipad:text-[18px] max-large:text-[20px] max-meduim:text-[16px]">
                Total Sale
              </div>
            </div>
      ...
      <div className="py-20 px-[115px] max-desktop:px-20 max-laptop:px-10 max-ipad:py-10 max-mobile:px-5">
        <h1 className="text-[38px] text-white font-[work-sans] font-semibold max-tablet:text-[30px] max-meduim:text-center">
          Trending Collection
        </h1>
        <h3 className="text-[22px] text-[#FFFFFF] font-[work-sans] max-tablet:text-[16px] max-meduim:text-center">
          ...
          {data.map((value) => {
            return (
              <div className=" w-[30%] max-other:w-[65%] max-tablet:w-[85%] max-mobile:w-[100%]">
                <img
                  className="w-full hover:scale-95 ease-linear duration-200"
                  src={value.mainImg}
                  alt=""
                />
                <div className="flex justify-between mt-4">
                  <div
                    className="w-[30%] rounded-[20px] hover:scale-95 ease-linear duration-200 max-other:h-[150px] max-meduim:h-[100px]"
                    style={{
                      background: `url(${value.secondImg})`,
                  ...
                  <div
                    className="w-[30%] rounded-[20px] hover:scale-95 ease-linear duration-200 max-other:h-[150px] max-meduim:h-[100px]"
                    style={{
                      background: `url(${value.thirdImg})`,
                      backgroundRepeat: "no-repeat",
                      backgroundPosition: "center center",
                      backgroundSize: "cover",
                    }}
                  ></div>
                  <div className="w-[30%] h-[100px] hover:scale-95 ease-linear duration-200 bg-[#A259FF] flex justify-center items-center text-[22px] text-white font-[work-sans] font-semibold rounded-[20px] max-other:h-[150px] max-meduim:h-[100px] ">
                    <h1>{value.statistic}+</h1>
                  </div>
                </div>
                ...
                <div className="flex mt-3">
                  ...
                  <h3 className="text-[16px] text-white ml-[10px]">
                    {value.titleImgName}
                  </h3>
                </div>
              </div>
      ...
      <div className="py-20 px-[115px] font-[work-sans] text-white max-desktop:px-20 max-laptop:px-10 max-ipad:py-10 max-mobile:px-5">
        <h1 className="text-[38px] font-semibold max-meduim:text-center max-meduim:text-[30px]">
          Top creators
        </h1>

        <div className="flex justify-between items-end mt-[-30px] max-other:flex-wrap max-other:mt-5">
          <h2 className="text-[22px] font-normal max-ipad:max-w-[500px] max-other:max-w-[600px] max-meduim:text-center max-meduim:w-full max-meduim:text-[16px]">
            ...
            return (
              <div className="text-white font-[work-sans] w-[23%] my-[15px] h-auto bg-[#3B3B3B] rounded-[20px] p-5 relative flex justify-center flex-wrap items-center hover:scale-95 ease-linear duration-200 max-desktop:p-4 max-laptop:w-[30%] max-other:p-2 max-large:justify-between max-large:w-[48%] max-large:p-3 max-tablet:w-[75%] max-tablet:justify-around max-meduim:w-[90%] max-mobile:w-[100%]">
                <div className="w-[40px] h-[40px] bg-[#2B2B2B] rounded-[50%] absolute top-5 left-5 flex justify-center items-center max-other:top-1 max-other:left-1 max-large:w-[30px] max-large:h-[30px]">
                  <h1 className="text-[16px] text-[#858584] font-normal font-[space-mono] max-large:text-[13px]">
                    {value.id}
                  </h1>
                </div>
                <img
                  className="w-[120p] h-[120px] max-large:w-[60px] max-large:h-[60px]"
                  src={value.img}
                  alt=""
                />
                <div className="max-large:flex max-large:h-full flex-col justify-start">
                  <h1 className="text-[22px] text-white font-semibold w-full text-center mt-5 font-[work-sans] max-other:text-[20px] max-large:w-[0] max-large:leading-[0px]">
                    {value.title}
                  </h1>
                  <h2 className="text-[16px] font-normal text-white font-[space-mono] mt-2 max-desktop:text-[14px] max-other:text-[13px] max-large:mt-4">
                    {" "}
      ...
      <div className="py-20 px-[115px] font-[work-sans] text-white flex justify-between flex-wrap max-desktop:px-20 max-laptop:px-10 max-ipad:p-10 max-other:justify-around max-tablet:justify-between max-meduim:justify-between max-mobile:px-5 max-mobile:justify-center">
        <h1 className="text-[38px] font-semibold w-full max-meduim:text-center max-meduim:text-[30px]">
          Browse Categories
        </h1>
        ...
        {categorie.map((value) => {
          return (
            <div className="w-[23%] h-auto mt-[30px] bg-[#3B3B3B] rounded-[20px] overflow-hidden hover:scale-95 ease-linear duration-200 max-other:w-[45%] max-tablet:w-[48%] max-meduim:w-[47%] max-mobile:w-[90%]">
              <div
                className="relative w-full h-60 flex justify-center items-center max-other:h-[300px] max-meduim:h-[200px] max-mobile:h-72"
                style={{
              ...
              <div className="py-5 px-7 max-meduim:px-4">
                <h2 className="text-[22px] font-semibold max-ipad:text-[16px] max-other:text-[20px] max-meduim:text-[18px] ">
                  {value.title}
                </h2>
              </div>
            </div>
      ...
      <div className="py-20 px-[115px] font-[work-sans] text-white max-desktop:px-20 max-laptop:px-10 max-ipad:p-10 max-mobile:px-5">
        <h1 className="text-[38px] font-semibold max-meduim:text-[30px] max-meduim:text-center">
          Discover More NFTs
        </h1>
          ...
          {discovers.map((value) => {
            return (
              <div className="w-[30%] h-auto bg-[#3B3B3B] font-[work-sans] text-white rounded-[20px] overflow-hidden hover:scale-95 ease-linear duration-200 max-ipad:w-[32%] max-tablet:w-[70%] max-tablet:mt-[30px] max-meduim:w-[90%]">
                <div
                  className="w-full h-[300px] max-other:h-56 max-tablet:h-[320px]"
                  style={{
                ...
                <div className="py-5 px-[30px] max-other:px-5">
                  <h1 className="text-[22px] font-semibold max-other:text-[18px]">
                    {value.title}
                  </h1>
                  ...
                  <div className="font-[space-mono] mt-6 flex justify-between max-other:flex-col">
                    <h1 className="max-other:border-b-2 pb-[2px]">
                      <span className="text-[#858584] text-[12px] font-normal">
                        Price
                      </span>
                      <br />
                      {value.price} ETH
      ...
      <div className="highlight w-full h-[660px] flex justify-center items-center max-desktop:px-20 max-laptop:px-10">
        <div className="max-w-[300px] w-full p-[30px] rounded-[20px] text-center box-border  bg-[#3b3b3bd8] text-[35px] font-semibold font-[space-mono] text-white flex justify-between flex-wrap">
          <h1 className="w-full text-[12px] font-normal mb-3">
            Auction ends in:
          </h1>
      ...
      <div className="py-20 px-[155px] font-[work-sans] text-white max-desktop:px-20 max-laptop:px-10 max-ipad:p-10 max-meduim:text-center max-mobile:px-5 max-mobile:py-10">
        <h1 className="text-[38px] font-semibold max-meduim:text-[30px]">
          How it works
        </h1>
        <p className="text-[22px] text-[#FFFFFF] font-normal mt-2 max-meduim:text-[16px]">
          ...
          {icon.map((value) => {
            return (
              <div className="px-10 text-center font-[work-sans] py-5 bg-[#3B3B3B] w-[30%] rounded-[20px] mt-12 hover:scale-95 ease-linear duration-200  max-ipad:px-2 max-large:w-[32%] max-tablet:w-[70%] max-tablet:flex justify-between max-meduim:w-[90%] max-meduim:items-center max-mobile:w-full">
                <img
                  className="w-full max-tablet:w-24 max-tablet:h-24"
                  src={value.iconImg}
                  alt=""
                />

                <div className="max-tablet:text-left max-tablet:px-5">
                  <h1 className="text-[22px] font-semibold max-other:text-[19px] max-large:text-[16px] max-tablet:text-[19px] max-meduim:text-[16px]">
                    {value.title}
                  </h1>
                  <h2 className="text-[16px] font-normal mt-[10px] max-other:text-[14px] max-large:text-[12px]">
                    {value.info}
                  </h2>
                </div>
              </div>
      ...
      <div className="py-20 px-[155px] font-[work-sans] text-white max-desktop:px-20 max-laptop:px-10 max-ipad:p-10">
        <div className="w-full h-auto p-[60px] bg-[#3B3B3B] rounded-[20px] flex justify-between flex-wrap max-desktop:p-[30px] max-ipad:flex-col items-center max-ipad:bg-transparent max-meduim:p-0 ">
          <div
            className=" rounded-[20px] max-w-[400px] w-full h-[300px] max-ipad:max-w-[450px] max-ipad:h-[350px]"
            style={{
              background: `url(${astranout})`,
              backgroundRepeat: "no-repeat",
              backgroundPosition: "center center",
              backgroundSize: "cover",
            }}
