...
const Home = () => {
    ...
    return (
        <div className='bg-[#2B2B2B] '>
            ...
            <div className='py-20 px-[115px] font-[work-sans] text-white flex justify-between flex-wrap max-desktop:px-20 max-laptop:px-10 max-ipad:p-10 max-other:justify-around'>
                <h1 className='text-[38px] font-semibold w-full max-meduim:text-center max-meduim:text-[30px]'>Browse Categories</h1>

                {
                    categorie.map(value => {
                        return (
                            <div className='w-[23%] h-auto mt-[30px] bg-[#3B3B3B] rounded-[20px] overflow-hidden hover:scale-95 ease-linear duration-200 max-other:w-[45%]'>
                                <div className='relative w-full h-60 flex justify-center items-center max-other:h-[300px]' style={{ background: `url(${value.img})`, backgroundPosition: 'center center', backgroundSize: 'cover' }}>
                                    <div className='absolute inset-0 backdrop-blur-[5px]'></div>
                                    <img className='relative z-[5]' src={value.icon} alt="" />
                                </div>
                                <div className='py-5 px-7'>
                                    <h2 className='text-[22px] font-semibold max-ipad:text-[16px] max-other:text-[20px]'>{value.title}</h2>
                                </div>
                            </div>
