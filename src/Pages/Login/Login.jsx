...
const Login = () => {
    return (
        <div className="w-full h-auto bg-[#2B2B2B] ">
            <div className="flex justify-between items-center bg-[#2B2B2B] flex-wrap px-[40px] py-5">
                ...
                <div className="flex-none">
                    <ul className="flex justify-start items-center gap-3 text-white font-[work-sans] font-[600] text-[14px] ">
                        <li>
                        ...
                        <fieldset className="form-control max-w-80 w-full">
                            ...
                            <div className="join ">
                                <input
                                    ...
                                    className="input input-bordered join-item rounded-[15px] h-[60px]"
                                />
                                <button className="btn h-[60px] rounded-[20px] bg-[#A259FF] hover:bg-[#A259FF] active:bg-[#A259FF] join-item font-[work-sans] text-white px-[50px] py-5">Subscribe</button>
                            </div>
                        </fieldset>
                    </form>
                </footer>
